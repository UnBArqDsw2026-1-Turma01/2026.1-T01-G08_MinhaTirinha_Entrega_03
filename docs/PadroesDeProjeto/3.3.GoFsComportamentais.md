...
Foi realizada uma reunião para apresentação e discussão da implementação do padrão Strategy, incluindo a explicação da lógica utilizada para persistência do progresso das tirinhas iniciadas pelo usuário.
...
<details>
  <summary><strong><a href="https://github.com/SamaraAlvess">Guilherme Flyan</a></strong></summary>
  <p></p>
</details>
