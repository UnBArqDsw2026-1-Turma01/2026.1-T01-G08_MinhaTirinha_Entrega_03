...
<details>
  <summary><strong><a href="https://github.com/DaviNegreiros">Davi Monteiro de Negreiros</a></strong></summary>
  <p>Achei o padrão observer um dos mais tranquilos de entender e principalmente de aplicar, o useState e setState ajudam bastante. Gostei muito também de fazer a explicação do Observer dessa página do GitPages</p>
</details>
...
#### 3.3.4.2. Implementação Técnica

**1. ComicService (Contexto)**
...
export class ComicService {
  ...
  // O serviço atua como orquestrador, delegando a execução para a estratégia
