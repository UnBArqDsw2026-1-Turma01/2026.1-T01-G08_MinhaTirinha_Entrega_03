...
O padrão Singleton é um padrão de projeto criacional que garante a existência de uma única instância de uma classe e fornece um ponto global de acesso a ela. No frontend do MinhaTirinha, essa instância única é o cliente Supabase exportado pelo módulo `source/mobile/utils/supabase.ts`.
...
## 3.1.4. Aplicação do Singleton no Frontend
...
| `1.2` | 14/05/2026 | Consolidando a Aplicação GoF Criacional Singleton no Frontend | [Pedro Henrique Pereira Santos](https://github.com/pedrohpsantos) | [Guilherme Flyan](https://github.com/GFlyan) |
