...
Conforme definido na [introdução](3.PadroesDeProjeto.md) nós optamos por desenvolver uma aplicação que represente o nosso backend utilizando o framework NestJS. *Redigido por [Guilherme Flyan](https://www.github.com/GFlyan).*
...
* Classe concreta de uma estratégia. *(Estratégias são explicadas no [módulo de padrões comportamentais](3.3.GoFsComportamentais.md))*
